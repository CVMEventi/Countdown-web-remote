  ...
  <div class="flex flex-col gap-2">
    ...
    <div v-if="currentTimer" class="flex gap-2 flex-wrap">
      ...
      <Card class="flex flex-col max-sm:flex-1" style="min-width: 250px">
        <SButton :disabled="readOnly" class="text-4xl mb-2 font-mono uppercase" @click="controller.start(currentTimerId)">Start</SButton>
        <SButton
          :disabled="readOnly || currentUpdate.isReset"
        ...
        <SButton :disabled="readOnly" class="text-4xl mb-2 font-mono uppercase" type="danger" @click="controller.reset(currentTimerId)">Reset</SButton>
        <div v-if="!readOnly" class="flex gap-2 justify-center">
      ...
      <Card v-if="!readOnly" class="flex-1">
    ...
    <Card v-if="!readOnly && presets && presets.length" class="inline-flex gap-2 overflow-x-auto">
      <SButton
...
import type { TimerEngineUpdate, TimerEngineUpdates } from '../protocol/TimerInterfaces.ts'
import type { TimerSettings, Timers } from '../protocol/config.ts'
